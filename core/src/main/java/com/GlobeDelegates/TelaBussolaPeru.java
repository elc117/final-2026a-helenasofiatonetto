...
public class TelaBussolaPeru implements Screen {
    ...
    public TelaBussolaPeru(GlobeDelegates jogo, Jogador jogador) {
        this.jogo = jogo;
    ...
    private void renderConclusao(float w, float h) {
        ...
        batch.end();
        if (Gdx.input.justTouched()) {
            jogo.setScreen(new TelaVilagemBussola(jogo, jogador, true, true, false));
        }
    }
