...
public class TelaVilagemAustria implements Screen {
    ...
    public TelaVilagemAustria(GlobeDelegates jogo, Jogador jogador, boolean escapeCompleto, boolean delegacaoCompleta) {
        this.jogo = jogo;
        ...
        fundo = new Texture("austria/telaEscolha.jpg");
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (dist < 80 && desbloqueado[i]) {
                ...
                if (Gdx.input.isKeyJustPressed(Keys.SPACE)) {
                    if (i == 0) jogo.setScreen(new TelaEscapeAustria(jogo, jogador));
                    if (i == 1) jogo.setScreen(new TelaDelegacaoAustria(jogo, jogador));
                    if (i == 2) jogo.setScreen(new TelaBonusAustria(jogo, jogador));
                }
            }
        }
