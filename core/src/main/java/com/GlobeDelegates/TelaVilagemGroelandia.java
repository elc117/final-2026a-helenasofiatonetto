...
public class TelaVilagemGroelandia implements Screen {
    ...
    public TelaVilagemGroelandia(GlobeDelegates jogo, Jogador jogador, boolean escapeCompleto, boolean delegacaoCompleta) {
        this.jogo = jogo;
        ...
        fundo = new Texture("groelandia/telaEscolha.jpg");
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (dist < 80 && desbloqueado[i]) {
                ...
                if (Gdx.input.isKeyJustPressed(Keys.SPACE)) {
                    if (i == 0) jogo.setScreen(new TelaEscapeGroelandia(jogo, jogador));
                    if (i == 1) jogo.setScreen(new TelaDelegacaoGroelandia(jogo, jogador));
                    if (i == 2) jogo.setScreen(new TelaBonusGroelandia(jogo, jogador));
                }
            }
        }
